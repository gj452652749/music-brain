...
public class MyRecord6 extends JFrame implements MouseListener{
	...
	public MyRecord6()
	{
		...
		//设置窗口上的图标
//		Image img = this.getToolkit().getImage("file:\\C:\\workplace\\study\\ai\\audio\\gamma.jpg");
//		this.setIconImage(img);
	...
	public void mouseReleased(MouseEvent e) {
		...
		if(e.getSource().equals(captureBtn))
		{
			...
			//将其放到指定的路径下
			//定义最终要存放的文件路径
			String destPath = "C:\\workplace\\study\\ai\\audio\\tmp\\";
			copyFile("C:\\"+tarFile.getName(), destPath);
	...
	public void save()
	{
        ...
        try {	
        	//以当前的时间命名录音的名字
        	//将录音的文件存放到F盘下语音文件夹下
        	File filePath = new File("C:\\workplace\\study\\ai\\audio");
        	String tarPath = "C:\\";
        	if(!filePath.exists())
        	{//如果文件不存在，则创建该目录
        		filePath.mkdirs();
            ...
            try {
				...
				Process p=run.exec(filePath+"\\"+"lame.exe -b 16 "+filePath+"\\"+file.getName()+" "+tarPath+tarFile.getName()); //16为码率，可自行修改
				//释放进程
